...
use Core\FFA\Listener\JoinListener;
use Core\FFA\Listener\KillListener;
use Core\FFA\Listener\QuitListener;
...
class Main extends PluginBase{
    ...
    public function onEnable() {
        ...
        $this->getLogger()->warning(TextFormat::YELLOW . base64_decode("UGx1Z2luIE1hZGUgQnkgUGx1dG9UaGVEZXZlbG9wZXIh"));
